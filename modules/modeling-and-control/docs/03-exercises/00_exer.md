...
Discretize the system in terms of velocity $v$ and the sampling time $T_s$ using exact discretisation TODO: ADD REFERENCE and test your discretization using the provided [Matlab-files](https://github.com/duckietown/docs-exercises/tree/master19/book/exercises/200_control_systems/additional_material)). What do you observe?
